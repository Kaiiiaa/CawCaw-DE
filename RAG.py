...
# --- Paths ---
PDF_FILES = [
    "[Seppe_vanden_Broucke,_Bart_Baesens]_Practical_Web.pdf",
    "CAPTCHA Vulnerabilities.pdf",
    "PyWebScrapingBook.pdf",
    "Scraping bot detection using.pdf",
    "TowardsAFrameworkForDetectingAdvancedWebBots.pdf"
]
